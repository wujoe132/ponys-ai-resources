# Rowan character SDK record

[Rowan on Ponys.ai](https://ponys.ai/characters/rowan) is the canonical public page
for the `rowan` record in the publisher resource SDK.
...
| Locale | `en` |
| Market | `GLOBAL` |
| Canonical URL | [https://ponys.ai/characters/rowan](https://ponys.ai/characters/rowan) |
