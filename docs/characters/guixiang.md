# GuiXiang character SDK record

[GuiXiang on Ponys.ai](https://ponys.ai/characters/guixiang) is the canonical public page
for the `guixiang` record in the publisher resource SDK.
...
| Locale | `en` |
| Market | `GLOBAL` |
| Canonical URL | [https://ponys.ai/characters/guixiang](https://ponys.ai/characters/guixiang) |
