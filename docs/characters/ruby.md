# Ruby character SDK record

[Ruby on Ponys.ai](https://ponys.ai/characters/ruby) is the canonical public page
for the `ruby` record in the publisher resource SDK.
...
| Locale | `en` |
| Market | `GLOBAL` |
| Canonical URL | [https://ponys.ai/characters/ruby](https://ponys.ai/characters/ruby) |
