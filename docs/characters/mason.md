# Mason character SDK record

[Mason on Ponys.ai](https://ponys.ai/characters/mason) is the canonical public page
for the `mason` record in the publisher resource SDK.
...
| Locale | `en` |
| Market | `GLOBAL` |
| Canonical URL | [https://ponys.ai/characters/mason](https://ponys.ai/characters/mason) |
