# Mizuki character SDK record

[Mizuki on Ponys.ai](https://ponys.ai/characters/mizuki) is the canonical public page
for the `mizuki` record in the publisher resource SDK.
...
| Locale | `en` |
| Market | `GLOBAL` |
| Canonical URL | [https://ponys.ai/characters/mizuki](https://ponys.ai/characters/mizuki) |
