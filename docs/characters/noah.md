# Noah character SDK record

[Noah on Ponys.ai](https://ponys.ai/characters/noah) is the canonical public page
for the `noah` record in the publisher resource SDK.
...
| Locale | `en` |
| Market | `GLOBAL` |
| Canonical URL | [https://ponys.ai/characters/noah](https://ponys.ai/characters/noah) |
