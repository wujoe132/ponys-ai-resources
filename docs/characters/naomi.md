# Naomi character SDK record

[Naomi on Ponys.ai](https://ponys.ai/characters/naomi) is the canonical public page
for the `naomi` record in the publisher resource SDK.
...
| Locale | `en` |
| Market | `GLOBAL` |
| Canonical URL | [https://ponys.ai/characters/naomi](https://ponys.ai/characters/naomi) |
