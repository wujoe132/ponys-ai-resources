# Vincent character SDK record

[Vincent on Ponys.ai](https://ponys.ai/characters/vincent) is the canonical public page
for the `vincent` record in the publisher resource SDK.
...
| Locale | `en` |
| Market | `GLOBAL` |
| Canonical URL | [https://ponys.ai/characters/vincent](https://ponys.ai/characters/vincent) |
