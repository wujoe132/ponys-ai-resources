# Darius character SDK record

[Darius on Ponys.ai](https://ponys.ai/characters/darius) is the canonical public page
for the `darius` record in the publisher resource SDK.
...
| Locale | `en` |
| Market | `GLOBAL` |
| Canonical URL | [https://ponys.ai/characters/darius](https://ponys.ai/characters/darius) |
