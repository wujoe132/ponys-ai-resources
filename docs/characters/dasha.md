# Dasha character SDK record

[Dasha on Ponys.ai](https://ponys.ai/characters/dasha) is the canonical public page
for the `dasha` record in the publisher resource SDK.
...
| Locale | `en` |
| Market | `GLOBAL` |
| Canonical URL | [https://ponys.ai/characters/dasha](https://ponys.ai/characters/dasha) |
