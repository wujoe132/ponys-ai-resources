# Safira character SDK record

[Safira on Ponys.ai](https://ponys.ai/characters/safira) is the canonical public page
for the `safira` record in the publisher resource SDK.
...
| Locale | `en` |
| Market | `GLOBAL` |
| Canonical URL | [https://ponys.ai/characters/safira](https://ponys.ai/characters/safira) |
