# Yuna character SDK record

[Yuna on Ponys.ai](https://ponys.ai/characters/yuna) is the canonical public page
for the `yuna` record in the publisher resource SDK.
...
| Locale | `en` |
| Market | `GLOBAL` |
| Canonical URL | [https://ponys.ai/characters/yuna](https://ponys.ai/characters/yuna) |
