# Soyeon character SDK record

[Soyeon on Ponys.ai](https://ponys.ai/characters/soyeon) is the canonical public page
for the `soyeon` record in the publisher resource SDK.
...
| Locale | `en` |
| Market | `GLOBAL` |
| Canonical URL | [https://ponys.ai/characters/soyeon](https://ponys.ai/characters/soyeon) |
