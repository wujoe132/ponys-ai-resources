# Summer character SDK record

[Summer on Ponys.ai](https://ponys.ai/characters/yuwei) is the canonical public page
for the `yuwei` record in the publisher resource SDK.
...
| Locale | `en` |
| Market | `GLOBAL` |
| Canonical URL | [https://ponys.ai/characters/yuwei](https://ponys.ai/characters/yuwei) |
