# Zaria Cole character SDK record

[Zaria Cole on Ponys.ai](https://ponys.ai/characters/zaria-cole) is the canonical public page
for the `zaria-cole` record in the publisher resource SDK.
...
| Locale | `en` |
| Market | `GLOBAL` |
| Canonical URL | [https://ponys.ai/characters/zaria-cole](https://ponys.ai/characters/zaria-cole) |
